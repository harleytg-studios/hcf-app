...
EXPECTED_VERSION_CODE = 10000094
EXPECTED_INTERNAL_BUILD = 114
...
require("canonical v10000094 workflow missing", any(path.name == "build-dev-v10000094.yml" for path in workflows))
