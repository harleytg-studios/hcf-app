...
final class ReleaseNotes {
    static final String SUMMARY = "Harley's Clan Forum v1.0 Stable • Build 10000032";

    static final String NOTES =
            "Harley\'s Clan Forum v1.0 Stable • Build 10000032\n" +
            "• Stable feature update using Android versionCode 10000032.\n" +
            "• Public version remains v1.0; update comparison uses the APK's embedded versionCode.\n\n" +
            "Updated • App Updates\n" +
            "• Smarter APK versionCode detection, filename-independent releases, verified downloads, automatic installer handoff, and install-ready fallback notifications.\n\n" +
            "Updated • Forum Notifications\n" +
            "• Private-message notifications now extract readable sender/message text, avoid raw JSON, and can open the matching conversation directly.\n\n" +
            "Preserved\n" +
            "• Stable branding, com.harleytg.forum package identity, Account & Identity, Contact Support, Logs & Diagnostics, App Links, themes, performance profiles, and existing forum routing remain available.";
    ...
    static void showCustom(Activity activity, SharedPreferences prefs, boolean markSeenOnDismiss) {
        ...
        TextView version = label(activity, BuildInfo.VERSION_TAG + "  •  " + BuildInfo.CHANNEL + "  •  Build " + BuildInfo.VERSION_CODE, 11, R.color.hcf_cyan_bright, true);
        ...
        addSection(activity, body, "Harley's Clan Forum v1.0 Stable • Build 10000032",
                "This Stable feature update remains public version v1.0 while Android versionCode advances to 10000032 for a proper in-place update from Stable 10000020.");

        addSection(activity, body, "Updated • App Updates",
                "Update checks now compare the downloaded APK's embedded versionCode, do not depend on the APK filename, validate the Stable package/signing identity, and hand off verified downloads to Android's installer automatically.");

        addSection(activity, body, "Updated • Forum Notifications",
                "Private-message notifications now prefer readable sender and message text instead of raw JSON, support direct conversation routing, and improve duplicate/count handling.");
