...
final class ReleaseNotes {
    ...
    static void showCustom(Activity activity, final SharedPreferences sharedPreferences, boolean z) {
        ...
        TextView label2 = label(activity, "v1.0  •  Stable", 11, R.color.hcf_cyan_bright, true);
        ...
        addSection(activity, linearLayout4, "Harley's Clan Forum (app) v1.0", "This is Stable build " + BuildInfo.VERSION_CODE + ". The public version remains 1.0 while the Android versionCode advances for normal in-place upgrades.");
