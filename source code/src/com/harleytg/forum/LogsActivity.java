...
public final class LogsActivity extends ThemedActivity {
    ...
    private View buildHeader() {
        ...
        iconButton.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda7
    ...
    private View buildTabs() {
        ...
        linearLayout.setOrientation(0);
        linearLayout.setGravity(16);
        this.logsTab = segmentButton("Logs", new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LogsActivity.this.m29lambda$buildTabs$1$comharleytgforumdevLogsActivity(view);
            }
        });
        this.diagnosticsTab = segmentButton("Diagnostics", new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private View buildActionRow() {
        LinearLayout linearLayout = new LinearLayout(this);
        linearLayout.setOrientation(0);
        linearLayout.addView(actionButton("Refresh", new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LogsActivity.this.m22lambda$buildActionRow$3$comharleytgforumdevLogsActivity(view);
            }
        }), weightedActionParams(0, 0));
        linearLayout.addView(actionButton("Copy", new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LogsActivity.this.m23lambda$buildActionRow$4$comharleytgforumdevLogsActivity(view);
            }
        }), weightedActionParams(6, 0));
        linearLayout.addView(actionButton("Export", new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LogsActivity.this.m24lambda$buildActionRow$5$comharleytgforumdevLogsActivity(view);
            }
        }), weightedActionParams(6, 0));
        Button actionButton = actionButton("Clear", new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda12
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private LinearLayout buildLogsControls() {
        ...
        this.searchInput.addTextChangedListener(new TextWatcher() { // from class: com.harleytg.forum.LogsActivity.1
    ...
    private void rebuildFilterChips() {
        ...
        chipButton.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void addFilterChip(LinearLayout linearLayout, String str, final String str2) {
        ...
        chipButton.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void switchMode(String str) {
        ...
        if (button != null) {
            ...
            if (MODE_LOGS.equals(this.currentMode)) {
                onClickListener = new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                ...
                onClickListener = new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
    ...
    */
    ...
    private void renderDiagnostics() {
        ...
        if (scrollView != null) {
            scrollView.post(new Runnable() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda15
    ...
    private View buildRecoveryView(Throwable th) {
        ...
        linearLayout2.addView(actionButton("Clear Local Logs", new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda13
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LogsActivity.this.m27lambda$buildRecoveryView$14$comharleytgforumdevLogsActivity(view);
            }
        }), new LinearLayout.LayoutParams(-1, dp(48)));
        Button actionButton = actionButton("Back to App Settings", new View.OnClickListener() { // from class: com.harleytg.forum.LogsActivity$$ExternalSyntheticLambda14
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
