...
final class BuildInfo {
    ...
    static final String APK_FILE_NAME = "HCF-Beta-v10000087.apk";
    ...
    static final int INTERNAL_BUILD = 107;
    ...
    static final String USER_AGENT_MARKER = "HarleysClanForumApp/1.0 Build/10000087";
    static final String VERSION = "1.0";
    static final int VERSION_CODE = 10000087;
