...
final class BuildInfo {
    ...
    static final String APK_FILE_NAME = "HCF-Beta-v10000086.apk";
    ...
    static final int INTERNAL_BUILD = 106;
    ...
    static final String USER_AGENT_MARKER = "HarleysClanForumApp/1.0 Build/10000086";
    static final String VERSION = "1.0";
    static final int VERSION_CODE = 10000086;
