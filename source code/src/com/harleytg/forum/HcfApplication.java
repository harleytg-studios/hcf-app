...
public final class HcfApplication extends Application {
    ...
    public void onCreate() {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: com.harleytg.forum.dev.HcfApplication$$ExternalSyntheticLambda2
        ...
        AppExecutors.main().postDelayed(new Runnable() { // from class: com.harleytg.forum.dev.HcfApplication$$ExternalSyntheticLambda3
    ...
    /* synthetic */ void m9lambda$onCreate$3$comharleytgforumdevHcfApplication() {
        AppExecutors.disk().execute(new Runnable() { // from class: com.harleytg.forum.dev.HcfApplication$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                HcfApplication.this.m7lambda$onCreate$1$comharleytgforumdevHcfApplication();
            }
        });
        AppExecutors.network().execute(new Runnable() { // from class: com.harleytg.forum.dev.HcfApplication$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
