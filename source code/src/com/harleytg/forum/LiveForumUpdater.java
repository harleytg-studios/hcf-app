...
final class LiveForumUpdater {
    ...
    private final Runnable tick = new Runnable() { // from class: com.harleytg.forum.LiveForumUpdater$$ExternalSyntheticLambda1
        ...
        if (this.running) {
            ...
            try {
                ...
                if (pageKey == null || endpointFor == null) {
                    ...
                    this.inFlight = true;
                    AppExecutors.network().execute(new Runnable() { // from class: com.harleytg.forum.LiveForumUpdater$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
