...
public final class CookieManagerActivity extends ThemedActivity {
    ...
    private View buildUi() {
        ...
        iconButton.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.CookieManagerActivity$$ExternalSyntheticLambda0
        ...
        linearLayout3.addView(action("Refresh cookie data", new View.OnClickListener() { // from class: com.harleytg.forum.CookieManagerActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CookieManagerActivity.this.m1lambda$buildUi$1$comharleytgforumdevCookieManagerActivity(view);
            }
        }));
        linearLayout3.addView(action("Clear all cookies + Web storage", new View.OnClickListener() { // from class: com.harleytg.forum.CookieManagerActivity$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private View cookieCard(final CookieEntry cookieEntry) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.CookieManagerActivity$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.CookieManagerActivity$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void clearAll() {
        ...
        cookieManager.removeAllCookies(new ValueCallback() { // from class: com.harleytg.forum.CookieManagerActivity$$ExternalSyntheticLambda5
