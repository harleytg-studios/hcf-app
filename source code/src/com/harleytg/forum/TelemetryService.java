...
final class TelemetryService {
    ...
    static void sendEvent(Context context, String str, String str2) {
        ...
        AppExecutors.network().execute(new Runnable() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda9
    ...
    static void sendDiagnosticEvent(Context context, final String str, final String str2) {
        if (context != null && isDiagnostics(context) && safeBoolean(prefs(context), "telemetry_auto_error_reports", false)) {
            final Context applicationContext = context.getApplicationContext();
            AppExecutors.network().execute(new Runnable() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private static void sendDiagnosticEventForced(Context context, final String str, final String str2) {
        ...
        final Context applicationContext = context.getApplicationContext();
        AppExecutors.network().execute(new Runnable() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    static void handlePendingCrash(final Activity activity) {
        ...
        create.setOnShowListener(new DialogInterface.OnShowListener() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda6
    ...
    static /* synthetic */ void lambda$handlePendingCrash$6(final AlertDialog alertDialog, final Activity activity, final EditText editText, final Switch r10, final String str, DialogInterface dialogInterface) {
        alertDialog.getButton(-1).setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                TelemetryService.lambda$handlePendingCrash$3(activity, editText, r10, str, alertDialog, view);
            }
        });
        alertDialog.getButton(-3).setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        alertDialog.getButton(-2).setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    static void showManualFeedbackDialog(final Activity activity) {
        ...
        new AlertDialog.Builder(activity).setTitle("Send diagnostic feedback").setView(linearLayout).setPositiveButton("Send", new DialogInterface.OnClickListener() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda4
    ...
    private static void sendPendingCrash(Context context, final String str, final boolean z) {
        ...
        AppExecutors.network().execute(new Runnable() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private static void sendManualFeedback(Context context, final String str, final boolean z) {
        final Context applicationContext = context.getApplicationContext();
        AppExecutors.network().execute(new Runnable() { // from class: com.harleytg.forum.dev.TelemetryService$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private static JSONObject buildBaseReport(Context context, String str, String str2, String str3, Boolean bool) throws Exception {
        ...
        jSONObject.put("versionCode", 10000071);
    ...
    private static JSONObject discordPayload(JSONObject jSONObject) throws Exception {
        ...
        jSONArray.put(field("Build", jSONObject.optInt("internalBuild", 100) + " / " + jSONObject.optInt("versionCode", 10000071), true));
