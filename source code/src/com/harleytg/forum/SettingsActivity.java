...
public final class SettingsActivity extends ThemedActivity {
    ...
    private void showSettingsRecovery(Throwable th) {
        try {
            ...
            button.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda38
    ...
    private View buildHeader() {
        ...
        this.headerBackButton.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda74
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        TextView text2 = text("Harley's Clan Forum v1.0 [Stable]", 10, getColor(R.color.hcf_meta));
    ...
    private void showSettingsHome() {
        ...
        updateSettingsHeader("App Settings", "Harley's Clan Forum v1.0 [Stable]");
        ...
        addSettingsCategory(linearLayout2, "Notifications", "Required alerts, silent background alerts and notification tools", "notifications", "alerts notification history background silent test delivery");
        ...
        editText.addTextChangedListener(new TextWatcher() { // from class: com.harleytg.forum.SettingsActivity.1
        ...
        TextView text3 = text("Harley's Clan Forum v1.0 [Stable]", 9, getColor(R.color.hcf_hint));
        text3.setGravity(17);
        text3.setPadding(0, dp(14), 0, dp(4));
        this.settingsContent.addView(text3);
        ScrollView scrollView = this.settingsScroll;
        if (scrollView != null) {
            scrollView.post(new Runnable() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda29
    ...
    private void showSettingsSection(String str) {
        ...
        switch (str2) {
            ...
            case "advanced":
                ...
                if (devToolsEnabled()) {
                    this.settingsContent.addView(connectedSettingsPanel("Developer Tools", "Stable test controls", developerToolsCard(), this.openDeveloperToolsOnAdvanced));
                }
            ...
            case "notifications":
                ...
                this.settingsContent.addView(connectedSettingsPanel("HCF Test Alerts", "Stable test channel • controls live in Developer Tools", testAlertsInfoCard(), false));
                break;
        ...
        this.settingsContent.addView(actionButton("‹  Back to all settings", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        ScrollView scrollView = this.settingsScroll;
        if (scrollView != null) {
            scrollView.post(new Runnable() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private View settingsCategoryRow(String str, String str2, final String str3) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda68
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void updateSettingsHeader(String str, String str2) {
        ...
        if (textView2 != null) {
            if (str2 == null) {
                str2 = "Harley's Clan Forum v1.0 [Stable]";
            }
    ...
    private String settingsSectionSubtitle(String str) {
        return "Harley's Clan Forum v1.0 [Stable]";
    }
    ...
    private View statusDashboardCard() {
        ...
        card.addView(actionButton("Sync Forum & Notifications Now", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda12
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* synthetic */ void m181xc36f4660(View view) {
        ...
        getWindow().getDecorView().postDelayed(new Runnable() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda44
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private View accountIdentityCard() {
        ...
        card.addView(actionButton("Open Account & Identity", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda42
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private View accountControlsCard() {
        ...
        if (!load.loggedIn) {
            ...
            card.addView(text);
            card.addView(actionButton("Open Forum Sign In", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda70
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        card.addView(text3);
        card.addView(actionButton("Open My Forum Profile", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda71
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m136xe5f86ae4(load, view);
            }
        }));
        card.addView(actionButton("Open Account Security", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda72
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private View mainAlertsCard() {
        ...
        if (Build.VERSION.SDK_INT >= 33 && checkSelfPermission("android.permission.POST_NOTIFICATIONS") != 0) {
            card.addView(actionButton("Allow Android Notification Permission", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda43
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private View silentAlertsCard() {
        ...
        r1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda36
        ...
        r12.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda37
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
    ...
    private View testAlertsInfoCard() {
        LinearLayout card = card();
        NotificationHelper.createChannel(this);
        card.addView(notificationChannelRow("HCF Test Alerts", "Stable test notifications • isolated from real HCF Alerts", "hcf_test_alerts_v1"));
        ...
        card.addView(text);
        if (devToolsEnabled()) {
            card.addView(actionButton("Open Developer Tools", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda30
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private View notificationToolsCard() {
        ...
        card.addView(actionButton("All Android Notification Settings", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda45
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private Button themeChoiceButton(String str, final String str2, boolean z) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda59
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void selectThemeMode(final String str, final Button button) {
        ...
        button.animate().scaleX(0.97f).scaleY(0.97f).setDuration(65L).withEndAction(new Runnable() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda40
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private View interfaceCard() {
        ...
        actionButton.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        r4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda3
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r42.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda4
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda5
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
    ...
    private View connectionCard() {
        ...
        r1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda13
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r12.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda14
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        card.addView(r12);
        card.addView(actionButton("Retry Primary Forum on Next Open", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda15
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        card.addView(text2);
        card.addView(actionButton("Open Forum Link Settings", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda16
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private View privacyCard() {
        ...
        card.addView(actionButton("Open Cookie Manager", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda75
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m162lambda$privacyCard$26$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("Clear Forum Site Data & Sign Out", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda76
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* synthetic */ void m164lambda$privacyCard$28$comharleytgforumdevSettingsActivity(View view) {
        ...
        cookieManager.removeAllCookies(new ValueCallback() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda69
    ...
    private View telemetryCard() {
        ...
        r1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda46
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        actionButton.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda50
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        r4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda51
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r42.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda52
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r43.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda53
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda54
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r32.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda55
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r33.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda56
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r34.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda57
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        card.addView(r34);
        card.addView(actionButton("Send Diagnostic Feedback", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda58
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m191lambda$telemetryCard$38$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("Preview Telemetry Report", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda47
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m192lambda$telemetryCard$39$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("View Report History", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda48
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m193lambda$telemetryCard$40$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("Clear Local Telemetry Reports", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda49
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private View securityCard() {
        ...
        card.addView(text);
        card.addView(actionButton("Allow Notification Permission", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda31
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m165lambda$securityCard$42$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("Allow Secure App Updates", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda32
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m166lambda$securityCard$43$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("Android App Permission Settings", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda33
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private View diagnosticsCard() {
        ...
        card.addView(actionButton("Run Error & Recovery Check", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda24
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m151xf21cbf(view);
            }
        }));
        card.addView(actionButton("Copy Sanitized Diagnostic Report", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda25
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m152x8d9247c0(view);
            }
        }));
        card.addView(actionButton("View App & Crash Logs", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda26
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m153x1a3272c1(view);
            }
        }));
        card.addView(actionButton("Clear WebView Cache", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda27
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void showRecoveryDiagnostics() {
        ...
        sb.append(safeUrl);
        new AlertDialog.Builder(this).setTitle("Error & Recovery Check").setMessage(sb.toString()).setPositiveButton("OK", (DialogInterface.OnClickListener) null).setNeutralButton("View logs", new DialogInterface.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda19
    ...
    private View updateCard() {
        ...
        r1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda6
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r12.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda7
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        r13.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda8
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        card.addView(r13);
        card.addView(actionButton("Check for Updates", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m200lambda$updateCard$54$comharleytgforumdevSettingsActivity(view);
            }
        }));
        Button actionButton = actionButton("Download Update Now", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        Button actionButton2 = actionButton("Install Downloaded Update", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* synthetic */ void m201lambda$updateCard$55$comharleytgforumdevSettingsActivity(View view) {
        ...
        if (release != null && release.apkUrl != null && !this.availableRelease.apkUrl.isEmpty()) {
            ...
            if (enqueue > 0) {
                ...
                StringBuilder sb = new StringBuilder("Downloading Stable build");
    ...
    private String updateChannelLine(String str) {
        return "Channel: ".concat("stable".equalsIgnoreCase(str) ? "Stable • Official Releases" : "Stable • Official Releases");
    }
    ...
    private void showUpdateChannelDialog() {
        ...
        new AlertDialog.Builder(this).setTitle("Update Channel").setSingleChoiceItems(new String[]{"Stable — Official releases", "Dev — Official releases"}, i, (DialogInterface.OnClickListener) null).setPositiveButton("Save", new DialogInterface.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda28
            @Override // android.content.DialogInterface.OnClickListener
    ...
    private void checkForUpdates(final boolean z) {
        ...
        this.availableRelease = null;
        UpdateChecker.check(this, effectiveUpdateChannel, new UpdateChecker.Callback() { // from class: com.harleytg.forum.SettingsActivity.2
            ...
            public void onResult(UpdateChecker.Release release, boolean z2) {
                ...
                if (z2) {
                    ...
                    StringBuilder sb = new StringBuilder("Stable Update Available\nInstalled: v1.0 (10000072)\nAvailable: v");
                    ...
                    if (z) {
                        ...
                        StringBuilder sb2 = new StringBuilder("Stable update available");
                        if (release.versionCode > 0) {
    ...
    public void watchUpdateDownloadForAutoInstall(final long j) {
        ...
        runnableArr[0] = new Runnable() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda73
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void handleInstallIntent(Intent intent) {
        if (intent == null || !"com.harleytg.forum.INSTALL_UPDATE".equals(intent.getAction())) {
            return;
        }
        final long longExtra = intent.getLongExtra("download_id", -1L);
        if (longExtra > 0) {
            getWindow().getDecorView().postDelayed(new Runnable() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda18
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private View aboutCard() {
        LinearLayout card = card();
        card.addView(settingsInfoCard("App identity", "Harley's Clan Forum\nVersion 1.0 • Build 10000072\nHarley's Clan Forum v1.0 [Stable]", R.drawable.fa_circle_info));
        card.addView(settingsInfoCard("Build & channel", "Channel: Stable • Update feed: stable\nPackage: " + getPackageName() + "\nAPK: Harley's Clan Forum.apk", R.drawable.fa_download));
        ...
        card.addView(actionButton("View What's New • v1.0", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda20
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m130lambda$aboutCard$60$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("Release & Build Details", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda21
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m131lambda$aboutCard$61$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("Copy App Information", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda22
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m132lambda$aboutCard$62$comharleytgforumdevSettingsActivity(view);
            }
        }));
        card.addView(actionButton("Contact Support", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda23
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private View connectedSettingsPanel(String str, String str2, View view, boolean z) {
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda41
            @Override // android.view.View.OnClickListener
    ...
    static /* synthetic */ void lambda$connectedSettingsPanel$65(boolean[] zArr, TextView textView, final LinearLayout linearLayout, final LinearLayout linearLayout2, View view) {
        if (zArr[0]) {
            ...
            linearLayout.animate().alpha(0.0f).scaleY(0.96f).setDuration(150L).withEndAction(new Runnable() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda35
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private boolean devToolsEnabled() {
        return "com.harleytg.forum".equals(getPackageName());
    }

    private View developerToolsCard() {
        LinearLayout card = card();
        card.addView(settingsInfoCard("Stable environment", "Beta-only tools • " + getPackageName() + "\nBuild 10000072 • channel Stable • update feed stable", R.drawable.fa_bug));
        ...
        card.addView(actionButton("Notification Test Console", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda60
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m143xad9949bf(view);
            }
        }));
        card.addView(actionButton("Test Notification Service", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda61
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m144x3a3974c0(view);
            }
        }));
        card.addView(actionButton("Force Notification Sync", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda62
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        card.addView(actionButton("Runtime Snapshot", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda63
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m146x5379cac2(view);
            }
        }));
        card.addView(actionButton("Run Error & Recovery Check", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda64
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        card.addView(actionButton("Copy Sanitized Diagnostic Report", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda65
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsActivity.this.m148xf5dda7d9(view);
            }
        }));
        card.addView(actionButton("View App & Crash Logs", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda66
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        card.addView(actionButton("Send Test Telemetry", new View.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda67
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void showNotificationTestConsole() {
        new AlertDialog.Builder(this).setTitle("Notification Test Console").setItems(new String[]{"Direct message", "Mention", "Discussion reply", "General HCF alert"}, new DialogInterface.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda17
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showDeveloperRuntimeSnapshot() {
        ...
        new AlertDialog.Builder(this).setTitle("Runtime Snapshot").setMessage(str).setPositiveButton("Close", (DialogInterface.OnClickListener) null).setNeutralButton("Copy", new DialogInterface.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda39
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showPerformanceProfileDialog(final Button button) {
        ...
        new AlertDialog.Builder(this).setTitle("Performance Profile").setSingleChoiceItems(strArr2, i, new DialogInterface.OnClickListener() { // from class: com.harleytg.forum.SettingsActivity$$ExternalSyntheticLambda34
            @Override // android.content.DialogInterface.OnClickListener
