...
final class NotificationHelper {
    ...
    private static void postInternal(
        ...
        open.setAction("com.harleytg.forum.OPEN_NOTIFICATION");
    ...
    static void postUpdateAvailable(Context context, UpdateChecker.Release release) {
        ...
        try {
            ...
            builder.setSmallIcon(R.drawable.ic_notification_paw)
                    ...
                    .setContentTitle("Stable update available")
                    .setContentText("v" + UpdateChecker.displayVersion(release) + (release != null && release.versionCode > 0 ? " • build " + release.versionCode : "") + " is ready for Stable.")
                    .setContentIntent(pending)
                    .setAutoCancel(true)
    ...
    static void postUpdateReady(Context context, String tag, long downloadId) {
        ...
        try {
            ...
            install.setAction("com.harleytg.forum.INSTALL_UPDATE");
